...
# Title: Signal From File
# Generated: Sun Nov 22 12:49:00 2015
##################################################
...
class signal_from_file(grc_wxgui.top_block_gui):

    def __init__(self):
        grc_wxgui.top_block_gui.__init__(self, title="Signal From File")
        ...
        self.connect((self.blocks_file_source_0, 0), (self.blocks_stream_to_vector_1, 0))    
